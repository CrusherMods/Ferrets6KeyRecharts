...
class PlayState extends MusicBeatState
{
	...
	override public function create()
	{
		...
		switch(stageCheck)
		{
			...
			case 'night': 
			{
				...
				var nightBG:FlxSprite = new FlxSprite(-200, -100).loadGraphic(Paths.image('halloween_bg','shared'));
			...
			var hills1:FlxSprite = new FlxSprite(-1900, -1006).loadGraphic(Paths.image('hills1','shared'));
			...
			var floor:FlxSprite = new FlxSprite(-1900, -996).loadGraphic(Paths.image('floor','shared'));
			...
			var smallflower:FlxSprite = new FlxSprite(-1900, -1006).loadGraphic(Paths.image('smallflower','shared'));
			...
			var smallflowe2:FlxSprite = new FlxSprite(-1900, -1006).loadGraphic(Paths.image('smallflowe2','shared'));
		...
		case 'SONICstage':
				...
				var bg2:FlxSprite = new FlxSprite(-355, -289 + 150).loadGraphic(Paths.image('FLOOR2'));
				bg2.updateHitbox();
				...
				var sticklol:FlxSprite = new FlxSprite(-200, -240).loadGraphic(Paths.image('STICKLOL'));
		...
		function doJumpscare(sound:Int = 0, opa:Int = 0)
			{
				...
				{
					case 0:
					FlxG.sound.play(Paths.sound('jumpscare', 'shared'), 0);
					FlxG.sound.play(Paths.sound('datOneSound', 'shared'), 0);
					case 1:
	...
	*/
					...
					if (note.burning) //fire note
						{
							...
							health -= 0.45;
							interupt = true;
							FlxG.sound.play(Paths.sound('burnSound','shared'));
						}
	...
	override function stepHit()
	{
		...
		if (SONG.song.toLowerCase() == 'too-slow' && curStep == 791)
			{
				shakeCam = false;
				shakeCam2 = false;
			}	
		...
		if (curStage == 'auditorHell' && curStep != stepOfLast)
			{
				switch(curStep)
				{
					//the stop signs just wouldn't work for whatever reason
					case 2655:
	...
	override function beatHit()
	{
		...
		switch (curStage)
		{
			...
			case 'arcade':
				bgcrowd.animation.play('dance', true);
				frontcrowd.animation.play('dance', true);
